  ...
  return (
    <View style={styles.container}>
      ...
      <Card style = {{marginBottom: 20}}>
        ...
        <Card style = {{marginBottom: 20}}>
        <SecondComp name = 'Using Second Component(Class)' pic = 'https://png.pngtree.com/png-vector/20190411/ourmid/pngtree-business-male-icon-vector-png-image_916468.jpg'/>
        </Card>
    </View>
  );
}
